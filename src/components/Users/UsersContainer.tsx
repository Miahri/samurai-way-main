...
import {
  followTC, getUsersThunkCreator, setCurrentPage,
  setFollowingInProgress, unfollowTC, UserPageType,
} from "../../redux/users-reducer";
import {Preloader} from "../../common/Preloader/Preloader";
import {Users} from "./Users";
import {
  getAllUsers, getCurrentPage, getFollowingInProgress,
...
export default connect(mapStateToProps, {
  followTC, unfollowTC, setCurrentPage, setFollowingInProgress, getUsersThunkCreator
})(UsersContainer);
